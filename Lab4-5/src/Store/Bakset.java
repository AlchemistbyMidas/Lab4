...
public class Bakset implements Serializable {
	private String color;
	private LocalDate timeOfPicingkUp;
	private int spaciousness; // Large // small//average 
	//private Set<Product> products;
	private List<Product> products;
	public Bakset(LocalDate timeOfPickUp,String color,int spaciousness) {
		this.timeOfPicingkUp=timeOfPickUp;
		this.color=color;
		this.spaciousness=spaciousness;
		this.products=new ArrayList<Product>();
	} 
	public Bakset(LocalDate timeOfPickUp,String color,int spaciousness,List<Product> newproducts) {
		this.timeOfPicingkUp=timeOfPickUp;
		this.color=color;
		this.spaciousness=spaciousness;
